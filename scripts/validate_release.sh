...
/usr/bin/lipo -verify_arch arm64 x86_64 "$APP_BINARY" || fail "app is not universal"
/usr/bin/lipo -verify_arch arm64 x86_64 "$HELPER_PATH" || fail "helper is not universal"
